...
class AuthenticationApi
{
     ...
     * @return \Dhl\Rest\Auth\Model\TokenResponse
     */
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return array of \Dhl\Rest\Auth\Model\TokenResponse, HTTP status code, HTTP response headers (array of strings)
     */
            ...
            switch ($statusCode) {
                case 200:
                    if (in_array('\Dhl\Rest\Auth\Model\TokenResponse', ['\SplFileObject', '\Psr\Http\Message\StreamInterface'], true)) {
                        ...
                        if ('\Dhl\Rest\Auth\Model\TokenResponse' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Dhl\Rest\Auth\Model\TokenResponse', []),
