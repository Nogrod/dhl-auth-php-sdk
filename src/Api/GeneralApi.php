...
use Dhl\Rest\Auth\ApiException;
use Dhl\Rest\Auth\Configuration;
use Dhl\Rest\Auth\HeaderSelector;
use Dhl\Rest\Auth\ObjectSerializer;
...
class GeneralApi
{
     ...
     * @return \Dhl\Rest\Auth\Model\GetSemanticVersion200Response
     */
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return array of \Dhl\Rest\Auth\Model\GetSemanticVersion200Response, HTTP status code, HTTP response headers (array of strings)
     */
            ...
            switch ($statusCode) {
                case 200:
                    if (in_array('\Dhl\Rest\Auth\Model\GetSemanticVersion200Response', ['\SplFileObject', '\Psr\Http\Message\StreamInterface'], true)) {
                        ...
                        if ('\Dhl\Rest\Auth\Model\GetSemanticVersion200Response' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Dhl\Rest\Auth\Model\GetSemanticVersion200Response', []),
